...
/**
 * Generate FAQPage JSON-LD schema from blog content.
 * Extracts Q&A pairs from the "Frequently Asked Questions" section.
 * Returns null if no FAQ section is found.
 */
export function generateFAQSchema(content) {
  // Find the FAQ section — starts after "## Frequently Asked Questions"
  ...
  while ((match = qaRegex.exec(faqContent)) !== null) {
    ...
    // Clean answer: collapse multiple lines, strip markdown formatting
