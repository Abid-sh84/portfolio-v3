...
1. [The Starting Point: Everything Works on Localhost](#the-starting-point-everything-works-on-localhost)
2. [Phase 1: The Private Repository Problem](#phase-1-the-private-repository-problem)
3. [Phase 2: Understanding What a Reverse Proxy Actually Does](#phase-2-understanding-what-a-reverse-proxy-actually-does)
4. [Phase 3: Frontend Changes Not Appearing After Deployment](#phase-3-frontend-changes-not-appearing-after-deployment)
5. [Phase 4: SSL Setup — The Biggest Milestone](#phase-4-ssl-setup--the-biggest-milestone)
6. [Phase 5: The DNS Confusion That Made Me Feel Dumb](#phase-5-the-dns-confusion-that-made-me-feel-dumb)
7. [Phase 6: The UFW Firewall Warning That Scared Me](#phase-6-the-ufw-firewall-warning-that-scared-me)
8. [Phase 7: Chrome Showing "Not Secure" After SSL Was Working](#phase-7-chrome-showing-not-secure-after-ssl-was-working)
9. [Phase 8: The IP Address SSL Error](#phase-8-the-ip-address-ssl-error)
10. [Phase 9: Adding WebSockets — Will This Break the REST API?](#phase-9-adding-websockets--will-this-break-the-rest-api)
11. [Phase 10: Firebase Cloud Messaging in Production](#phase-10-firebase-cloud-messaging-in-production)
12. [Phase 11: The Nginx Disaster I Caused Myself](#phase-11-the-nginx-disaster-i-caused-myself)
13. [Phase 12: The Nginx Default Page After Fixing SSL](#phase-12-the-nginx-default-page-after-fixing-ssl)
14. [Phase 13: Production Build Failure — Firebase Import Error](#phase-13-production-build-failure--firebase-import-error)
15. [The Final Architecture](#the-final-architecture)
16. [The Five Lessons That Actually Matter](#the-five-lessons-that-actually-matter)
