...
export const personalInfo = {
  ...
  subtitle: "MERN Stack · AI Integration · Production-Ready Apps",
  description:
...
export const education = [
  {
    ...
    status: "Graduated",
    description:
      "Completed BSc in Computer Science with a focus on software development, data structures, and algorithms. Graduated with a strong GPA of 9.15, consistently maintaining top academic performance while building real-world development projects.",
    coursework: [
